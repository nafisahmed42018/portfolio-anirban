...
const ExperienceJob = (props: Props) => {
  return (
    <div className=" flex flex-col items-start justify-center gap-9 text-monochrome90">
      {/* Experience Body Card */}
      {jobExp.map((job, index) => (
        <div
          key={index}
          className="xl:w-[1200px] w-[800px] flex items-start justify-between gap-[12] pb-8 border-b border-b-monochrome30"
        >
